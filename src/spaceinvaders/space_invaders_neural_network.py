...
class SpaceInvadersNeuralNetwork(NeuralNetwork):
    def __init__(self):
		...
		"""
        self._activation_functions = [leaky_relu, leaky_relu, leaky_relu, identity]
        self._activation_functions_derivative = [leaky_relu_derivative, leaky_relu_derivative, leaky_relu_derivative, identity_derivative]
